...
# poprawic od hostow
intent1 = Intent("h3", "10.0.0.6", 10, 100)
intent2 = Intent("h1", "10.0.0.4", 20, 101)
intent3 = Intent("h1", "10.0.0.5", 40, 103)
intent4 = Intent("h3", "10.0.0.6", 50, 105)
intent5 = Intent("h1", "10.0.0.5", 60, 107)
intent6 = Intent("h3", "10.0.0.4", 100, 109)
intent7 = Intent("h2", "10.0.0.5", 200, 111)
intent8 = Intent("h2", "10.0.0.6", 100, 113)
...
class RoutingController():
  ...
  def update(self):
    ...
    print "\n[RoutingController] Print DELAY between from h1 by: {}\n".format(routingController.links_state)
    self.routing()
